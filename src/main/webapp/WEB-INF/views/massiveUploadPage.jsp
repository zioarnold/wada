...
<div class="container text-center">
    <h5>Verr&agrave; eseguito un check verso LDAP per poi effettuare dei controlli sul DB.</h5>
    <br>
    <h5>Qualora utenza esista sull'ADLDS, tale utenza verr&agrave; censita come abilitata.</h5>
    <br>
