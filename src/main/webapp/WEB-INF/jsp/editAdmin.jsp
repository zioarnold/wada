...
<%
    List<QsAdmins> qsAdmins = (List<QsAdmins>) request.getAttribute("user_admin");
    for (QsAdmins admin : qsAdmins) {
%>
<div class="container text-center">
    <h2>Reset password</h2>
    <form action="/resetPassword?adminId=<%=admin.getId()%>" method="post">
